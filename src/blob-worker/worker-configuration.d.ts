/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=src/blob-worker/wrangler.jsonc --env=stage --strict-vars=false --env-interface=BlobEnv src/blob-worker/worker-configuration.d.ts` (hash: 5babcec23f1fe93e316c7d46535596bb)
// Runtime types generated with workerd@1.20260811.1 2026-07-23 nodejs_compat
interface __BaseEnv_BlobEnv {
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_BlobEnv {}
}
interface BlobEnv extends __BaseEnv_BlobEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AZURE_STORAGE_ACCOUNT" | "AZURE_CLIENT_ID" | "AZURE_TENANT_ID" | "SHA1_BLOB_CONTAINER" | "NTLM_BLOB_CONTAINER" | "AZURE_CLIENT_SECRET">> {}
}
