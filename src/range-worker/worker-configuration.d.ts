/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=src/range-worker/wrangler.jsonc --env=stage --strict-vars=false --env-interface=ApiEnv src/range-worker/worker-configuration.d.ts` (hash: 20946f72121a4e59de835edaca9d1f69)
// Runtime types generated with workerd@1.20260815.1 2026-07-23 nodejs_compat
interface __BaseEnv_ApiEnv {
	AZURE_STORAGE_ACCOUNT: string;
	AZURE_CLIENT_ID: string;
	AZURE_TENANT_ID: string;
	SHA1_BLOB_CONTAINER: string;
	NTLM_BLOB_CONTAINER: string;
	AZURE_CLIENT_SECRET: string;
	HIBP_PURGE_CACHE_SECRET: string;
	BLOB_ENTRYPOINT: Service<typeof import("./index").BlobEntrypoint>;
	PURGE_ENTRYPOINT: Service<typeof import("./index").PurgeEntrypoint>;
	RANGE_ENTRYPOINT: Service<typeof import("./index").default>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AZURE_STORAGE_ACCOUNT" | "AZURE_CLIENT_ID" | "AZURE_TENANT_ID" | "SHA1_BLOB_CONTAINER" | "NTLM_BLOB_CONTAINER" | "AZURE_CLIENT_SECRET" | "HIBP_PURGE_CACHE_SECRET">> {}
}
