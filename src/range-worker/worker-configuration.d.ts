/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=src/range-worker/wrangler.jsonc --config=src/blob-worker/wrangler.jsonc --env=stage --strict-vars=false --env-interface=ApiEnv src/range-worker/worker-configuration.d.ts` (hash: 203ac7da77f564e2abad6cc8d43a57b2)
...
interface __BaseEnv_ApiEnv {
	...
	BLOB_FETCHER: Service<typeof import("../blob-worker/index").default>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HIBP_PURGE_CACHE_SECRET">> {}
}
